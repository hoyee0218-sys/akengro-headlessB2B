...
export type CustomerIdentityQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type CustomerIdentityQuery = {
  customer: Pick<CustomerAccountAPI.Customer, 'id' | 'tags'> & {
    emailAddress?: CustomerAccountAPI.Maybe<
      Pick<CustomerAccountAPI.CustomerEmailAddress, 'emailAddress'>
    >;
    sparkLayerAuthentication?: CustomerAccountAPI.Maybe<
      Pick<CustomerAccountAPI.Metafield, 'value'>
    >;
    sparkLayerPriceLists?: CustomerAccountAPI.Maybe<
      Pick<CustomerAccountAPI.Metafield, 'value'>
    >;
    sparkLayerCompanyName?: CustomerAccountAPI.Maybe<
      Pick<CustomerAccountAPI.Metafield, 'value'>
    >;
    companyContacts: {
      nodes: Array<{
        company?: CustomerAccountAPI.Maybe<
          Pick<CustomerAccountAPI.Company, 'id'> & {
            locations: {
              nodes: Array<Pick<CustomerAccountAPI.CompanyLocation, 'id'>>;
            };
          }
        >;
      }>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CustomerIdentity($language: LanguageCode) @inContext(language: $language) {\n    customer {\n      id\n      tags\n      emailAddress {\n        emailAddress\n      }\n      sparkLayerAuthentication: metafield(\n        namespace: "sparklayer"\n        key: "authentication"\n      ) {\n        value\n      }\n      sparkLayerPriceLists: metafield(\n        namespace: "sparklayer"\n        key: "price_lists"\n      ) {\n        value\n      }\n      sparkLayerCompanyName: metafield(\n        namespace: "sparklayer"\n        key: "company_name"\n      ) {\n        value\n      }\n      companyContacts(first: 1) {\n        nodes {\n          company {\n            id\n            locations(first: 1) {\n              nodes {\n                id\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CustomerIdentityQuery;
    variables: CustomerIdentityQueryVariables;
  };
